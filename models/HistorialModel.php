<?php 
	...
	class HistorialModel extends Listable
	{
		...
		public function insertarHistoria($historia)
		{
			...
			$consulta-> bindParam(':unPeso', $historia['peso']);
			...
			$consulta-> bindParam(':unPc', $historia['pc']);
			$consulta-> bindParam(':unPpc', $historia['ppc']);
			$consulta-> bindParam(':unaTalla', $historia['talla']);
